    ...
    <main>
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            <div class="mt-4 grid grid-cols-12 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-5 2xl:gap-7.55">
                <!--card 1-->
                <div class="h-56 col-span-1 xl:col-span-3 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                    <div class="w-full h-full flex flex-col">
                        ...
                        <div class="bg-slate-100 h-[70%] flex flex-col justify-center items-center">
                            ...
                            <div class="space-x-2">
                                <button class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded">Start a Skill Track</button>
                                <button class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded">Start a Career Track</button>
                            </div>
                        </div>
                    </div>
                </div>
                <!--card 1-->
                <!--card 2-->
                <div class="xl:col-span-2 rounded-sm border border-stroke bg-white px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
                    <div class="w-full h-full flex flex-col">
                        <div class="border-b border-black-200 h-[30%] flex justify-center items-center">
            ...
            <div class="mt-4 md:grid-cols-2 md:gap-6 xl:grid-cols-5 2xl:gap-7.55">
                <div class="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 xl:grid-cols-3 2xl:gap-7.55">
                    ...
                    <div class="rounded-sm border border-stroke bg-white shadow-lg hover:shadow-xl transition duration-300 ease-in-out dark:border-strokedark dark:bg-boxdark">
                        <div class="w-full h-full flex flex-col">
                            <div class="border-b border-black-200 h-[30%] flex justify-center items-center">
                                <h1 class="font-medium text-2xl">{{ $course->course_name }}</h1>
                            </div>
                            <div class="bg-slate-100 h-[70%] flex flex-col justify-center items-center">
                                <img src="{{ $course->img_path }}" alt="{{ $course->title }}" class="w-full mb-4 h-1/2">
                                <p class="text-gray-500 mb-4 mx-5">{{ $course->short_description }}</p>
                                <a href="" class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded">View Course</a>
