...
@section('content')
    ...
    <div class="w-full  bg-gray-800   p-8 md:p-12 mb-8">
        ...
        <h1 class="text-gray-900 text-white text-3xl md:text-5xl font-extrabold mb-2">Course List</h1>
        <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-6">Static websites are now used to bootstrap lots
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 px-10">
                    ...
                    @foreach ($courses as $course)
                        <div
                            ...
                            <a href="#"
                                class="mx-2 my-2 bg-blue-100 text-blue-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md dark:bg-gray-700 dark:text-blue-400 mb-2">
                            ...
                            <div class="p-5 flex flex-col justify-center items-center">
                                ...
                                <a href="{{ route('enrollments.enroll', $course) }}"
                                    class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Take
                                    Course
