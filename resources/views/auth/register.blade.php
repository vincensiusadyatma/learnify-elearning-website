            ...
            <div class="p-4 space-y-4 md:space-y-6 sm:p-6"> 
                ...
                <form class="space-y-4 md:space-y-4" action="#">
                    ...
                    <div>
                        ...
                        <input type="tel" name="phone" id="phone" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2" placeholder="123-456-7890" required=""> <!-- Adjusted padding -->
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="password" name="confirm-password" id="confirm-password" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2" required=""> <!-- Adjusted padding -->
                    </div>
